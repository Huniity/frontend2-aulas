...
export default function Home() {
  return (
    <>
      <Navbar />
      <motion.div initial={{opacity: 0, x: -100}} animate={{opacity: 1, x: 0}} transition={{duration: 1.5}} className="flex w-screen h-screen items-center justify-center text-center bg-zinc-50 font-sans dark:bg-black">
